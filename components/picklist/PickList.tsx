...
function TeamSelector({ availableTeams, onAddTeam, selectedTeamNumbers }: TeamSelectorProps) {
  ...
  return (
    <Card className="p-4 rounded-2xl shadow-card dark:shadow-card-dark bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
      <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Available Teams</h3>
      ...
      <div className="flex flex-col space-y-2 mb-4">
        <Input
          ...
          className="bg-white dark:bg-neutral-700 border-neutral-200 dark:border-neutral-600 text-neutral-900 dark:text-neutral-100 text-sm"
        />
        <select
          value={sortBy}
      ...
      <div className="space-y-2 max-h-80 overflow-y-auto">
        {filteredTeams.length === 0 ? (
          <div className="text-center py-6 text-neutral-500 dark:text-neutral-400">
            ...
            <p className="text-xs text-neutral-400">Try adjusting your search</p>
          </div>
        ) : (
          filteredTeams.map((team) => (
            <div key={team.team_number} className="flex items-center justify-between p-3 border border-neutral-200 dark:border-neutral-600 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 hover:shadow-sm transition-all duration-300">
              ...
              <Button
                ...
                className="ml-2 px-3 py-2 rounded-lg bg-primary text-white hover:opacity-90 transition-opacity duration-300 flex-shrink-0 text-xs"
              >
