...
function AdminScoutingStatsInner() {
  ...
  const loadStats = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Failed to load scouting stats');
      setData(null);
    } finally {
      setLoading(false);
    }
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Forms submitted by your organization&apos;s members (org-only). Click a name to see all their forms.
            </p>
          </div>
