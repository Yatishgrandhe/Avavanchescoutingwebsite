  ...
  if (req.method === 'POST') {
    try {
      ...
      const scoutingData = {
        ...
        autonomous_points: calculateScore(autonomous || {}).final_score,
        teleop_points: calculateScore(teleop || {}).final_score,
        endgame_points: calculateScore(endgame || {}).final_score,
        final_score: calculateScore(autonomous || {}).final_score + calculateScore(teleop || {}).final_score + calculateScore(endgame || {}).final_score,
        notes: scoringNotes,
